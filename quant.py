...
# calculate log-likelihood for a given set of observations
...
# bucket FICO scores into categories based on the probability of default
def bucket_fico_scores(fico_scores, defaults, bins):
    ...
    # reconstruct the optimal bucket boundaries from the table
    boundaries = []
    k = 550
